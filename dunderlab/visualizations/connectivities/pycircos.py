...
class Gcircle:
    ...
    def chord_plot(self, start_list, end_list, facecolor=None, edgecolor=None, linewidth=0.0, arrowhead_width=0.07, arrowhead_length=50):
        """
        ...
        if sstart == ostart: 
            ...
            path_data = [(Path.MOVETO,  (sstart, stop)),
                         ...
                         # Punta de flecha
                         (Path.LINETO, ((sstart + send) * 0.5 - arrowhead_width, stop + z1)),
                         (Path.LINETO, ((sstart + send) * 0.5, stop + arrowhead_length)),
                         (Path.LINETO, ((sstart + send) * 0.5 + arrowhead_width, stop + z1)),

                         (Path.LINETO, (sstart, stop)),
